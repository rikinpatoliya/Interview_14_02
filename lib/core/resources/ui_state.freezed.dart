...
class __$$IdleImplCopyWithImpl<T, $Res>
    extends _$UiStateCopyWithImpl<T, $Res, _$IdleImpl<T>>
...
abstract class Idle<T> extends UiState<T> {
...
abstract class Loading<T> extends UiState<T> {
...
abstract class Success<T> extends UiState<T> {
...
abstract class Empty<T> extends UiState<T> {
...
class _$FailureImpl<T> extends Failure<T> {
  const _$FailureImpl({this.reason}) : super._();
...
abstract class Failure<T> extends UiState<T> {
  const factory Failure({final String? reason}) = _$FailureImpl<T>;
